...
public class CommandHandler {
        ...
        if (choice == 1) {
            ...
            if (user != null) {
                ...
                if (user.getRole().equalsIgnoreCase("Seller")) {
                    ...
                    System.out.println("Buyer menu not implemented yet."); // Placeholder
                } else if (user.getRole().equalsIgnoreCase("Agent")) {
                    System.out.println("Agent menu not implemented yet."); // Placeholder
    ...
    private void showSellerMenu(Scanner scanner) {
        System.out.println("\n--- Seller Menu ---");
        System.out.println("Seller menu not implemented yet."); // Placeholder
    }
}
